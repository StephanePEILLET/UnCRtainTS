...
ensemble_paths = [
    os.path.join(dirname, "inference", f"diagonal_1/export/epoch_{epoch}/{mode}"),
...
for instance in ensemble_paths:
    print(instance)
...
def main():
    ...
    for idx, sample_mean in enumerate(tqdm(samples)):
        ...
        extended_metrics = img_metrics(
            y[0],
            mean_ensemble.unsqueeze(dim=0),
